...
def create_app(test_config=None):
    ...
    def retrieve_categories():
        ...
        if len(categories) == 0:
            abort(404)
        categories_format =[cat.new_format() for cat in categories]
        categories_reformated =format_categories(categories_format)
        

        return jsonify(
            {
                "categories": categories_reformated,
    ...
    def view_question_categories(id):
